...
- **Public Hostname:** `esppostgrest.thebiomednest.com`
...
- Endpoint: `PATCH https://esppostgrest.thebiomednest.com/actuators?board_id=eq.esp32_core_1&component_name=eq.main_led`
